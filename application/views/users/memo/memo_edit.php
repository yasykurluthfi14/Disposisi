        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-file-text2"></i> Edit Memo</legend>
                <?php
                ...
                <form class="form-horizontal" action="" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <textarea name="memo" rows="2" cols="80" class="form-control" placeholder="Memo" required><?php echo $query->memo; ?></textarea>
                    </div>
                  </div>
